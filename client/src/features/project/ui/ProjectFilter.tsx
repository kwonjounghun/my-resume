...
interface ProjectFilterProps {
  ...
  onFilterChange: (filter: Partial<ProjectFilterType>) => void;
  onReset: () => void;
}
...
export function ProjectFilter({
  ...
  const [tempFilter, setTempFilter] = useState<ProjectFilterType>(filter);

  const handleTempFilterChange = (value: Partial<ProjectFilterType>) => {
